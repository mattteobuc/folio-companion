  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 px-4 py-12 dark:bg-zinc-950">
      <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">Accedi al tuo account per continuare.</p>
        ...
        <p className="mt-6 text-sm text-zinc-600 dark:text-zinc-400">
          Non hai un account?{" "}
          <Link href="/signup" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Registrati</Link>
        </p>
      </div>
    </main>
  );
